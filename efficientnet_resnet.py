...
def res_block(inputs, kernel_size, filters):
    fx = layers.Conv2D(filters, kernel_size, activation='relu', kernel_regularizer=regularizers.l2(1e-5), padding='same')(x)
    fx = layers.BatchNormalization()(fx)
    fx = layers.Conv2D(filters, kernel_size, kernel_regularizer=regularizers.l2(1e-5), padding='same')(fx)
    out = layers.Add()([x,fx])
    out = layers.ReLU()(out)
